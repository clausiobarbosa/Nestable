 ...
 *			dragMove
 *
 * Now, after the 'feedback.abort = true', the item return to original position. The method called is the 'dragStopAbort'. 
 * the index and parent index were needed.
 */
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            var onEndEvent = function (e) {
                ...
                if (feedback.abort) {
                    list.dragStopAbort(e.touches ? e.touches[0] : e, sourceList);
                    return;
                }
